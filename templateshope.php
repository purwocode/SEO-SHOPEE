...
<head>
  <meta charset="UTF-8">
<title><?php echo htmlspecialchars($BRAND); ?> - Produk & Penawaran Terbaik di Shopee</title>
<meta name="description" content=" Temukan produk dan layanan terbaik dari <?php echo $BRAND; ?>. Kunjungi halaman resmi <?php echo $BRAND; ?> untuk informasi terbaru, penawaran eksklusif, dan lebih banyak lagi." />
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
<meta name="robots" content="index, follow" />
<meta name="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] ?>/<?php echo htmlspecialchars($BRAND); ?>.html" />
<link rel="canonical" href="<?php echo 'https://' . $_SERVER['HTTP_HOST']?>" />
<meta name="og:title" content="<?php echo htmlspecialchars($BRAND); ?>" />
